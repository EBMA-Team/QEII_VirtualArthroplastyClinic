...
Virtual clinic reportedly saved the orthopaedic department at Frankston hospital \~\$250k and 300 outpatient clinic hours (2017-2018) by shifting 30% of their appointments for total knee cases to virtual followup [@lim2022].
...
Patient satisfaction after participating in a virtual clinic are also reasonably high [@elashmawy2021], however this has yet to be tested in a randomised trial.
...
::: {#tbl-question}
| Component | Study - Specific | Comments |
|----|----|----|
| Population | In patients presenting with end-stage knee arthritis at a public metropolitan hospital electing to undergo total knee arthroplasty |  |
| Intervention |  |  |
| Comparator |  |  |
| Outcomes |  |  |
| Study Design |  |  |
